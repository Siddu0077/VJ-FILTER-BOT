...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002383105891').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/telugu_movies_0_1') # give your force subscribe channel id here else leave it blank
...
PUBLIC_FILE_CHANNEL = environ.import re
from os import environ
from Script import script 
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/telugu_movies_group_2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+AP1vK0jFQthjODU1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'telugu_movies_group_2') # Support Chat Link Without https:// or @
get('PUBLIC_FILE_CHANNEL', '') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
